...
class UserGUI:
   def __init__(self, root, system):
       ...
       self.system.load_all_data()  # Load previously saved data.
   ...
   def create_purchase_tab(self):
       ...
       # Populate ticket type dropdown dynamically
   ...
   def purchase_ticket(self):
       ...
       # Update the ticket combobox in case tickets were modified externally
       self.ticket_type_combobox["values"] = [t.ticket_type for t in self.system.tickets]
